 ...
 *  20181026
 */
public class NumberChineseUtils {

    static final String CHN_NUMBER[] =  {"零","一","二","三","四","五","六","七","八","九"};
    static final String CHN_UNIT[] = {"","十","百","千"};//权位
    static final String CHN_UNIT_SECTION[] = {"","万","亿","万亿"};//节权位
    ...
    public static void main(String[] args) {
        String chn = numberToChn(22);
        System.out.println(chn);
        System.out.println(chnStringToNumber("二十二"));
    }
